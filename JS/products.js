...
export async function getProducts(){
    ...
    .then(()=>{
        ...
        arenaSanitaria.map((arena)=>{
            ...
            imagen.classList.add("w-[250px]", "rounded-lg" );
            lista.innerHTML = `<p>${arena.id} - ${arena.nombre} - Precio: $${arena.precio}</p>`;
        ...
        juguetes.map((juguete)=>{
            ...
            botones.innerHTML = `<svg id="juguete-car-${contadorJuguetes}" class="hover:scale-125" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <defs> <style>.cls-1{fill:none;stroke:#000000;stroke-linecap:round;stroke-linejoin:round;stroke-width:2px;}</style> </defs> <title></title> <g data-name="Layer 30" id="Layer_30"> <path class="cls-1" d="M12.52,13.59,63,13.39l-7.1,28H20.23l-8.86-32H1.25"></path> <circle class="cls-1" cx="23.83" cy="52.17" r="3.92"></circle> <circle class="cls-1" cx="53.1" cy="52.17" r="3.92"></circle> <line class="cls-1" x1="17.65" x2="58.29" y1="32.1" y2="32.1"></line> <line class="cls-1" x1="15" x2="60.7" y1="22.56" y2="22.56"></line> <line class="cls-1" x1="24.15" x2="24.15" y1="13.54" y2="41.41"></line> <line class="cls-1" x1="15.83" x2="15.83" y1="13.54" y2="25.54"></line> <line class="cls-1" x1="32.41" x2="32.41" y1="13.54" y2="41.41"></line> <line class="cls-1" x1="40.66" x2="40.66" y1="13.54" y2="41.41"></line> <line class="cls-1" x1="48.92" x2="48.92" y1="13.54" y2="41.41"></line> <line class="cls-1" x1="57.18" x2="57.18" y1="13.54" y2="36.47"></line> <path class="cls-1" d="M20.23,41.41V45.7a2.55,2.55,0,0,0,2.55,2.55H53.24"></path> </g> </g></svg>
                                <svg id="juguete-car-${contadorJuguetes}" class="hover:scale-125" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill-rule="evenodd" clip-rule="evenodd" d="M12 6.00019C10.2006 3.90317 7.19377 3.2551 4.93923 5.17534C2.68468 7.09558 2.36727 10.3061 4.13778 12.5772C5.60984 14.4654 10.0648 18.4479 11.5249 19.7369C11.6882 19.8811 11.7699 19.9532 11.8652 19.9815C11.9483 20.0062 12.0393 20.0062 12.1225 19.9815C12.2178 19.9532 12.2994 19.8811 12.4628 19.7369C13.9229 18.4479 18.3778 14.4654 19.8499 12.5772C21.6204 10.3061 21.3417 7.07538 19.0484 5.17534C16.7551 3.2753 13.7994 3.90317 12 6.00019Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>`;
            botones.classList.add("w-[80px]", "h-[60px]", "flex", "flex-row", "gap-[15px]","cursor-pointer")
            caja.appendChild(imagen);
            caja.appendChild(lista);
            caja.appendChild(botones);
            ...
            document.getElementById(`juguete-car-${contadorJuguetes}`).addEventListener("click", ()=>{
                let carritoActual = localStorage.getItem("carrito") ? JSON.parse(localStorage.getItem("carrito")) : [];
        ...
        vitaminas.map((vtn)=>{
            ...
            botones.innerHTML = `<svg id="vitamina-car-${contadorVitaminas}" class="hover:scale-125" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <defs> <style>.cls-1{fill:none;stroke:#000000;stroke-linecap:round;stroke-linejoin:round;stroke-width:2px;}</style> </defs> <title></title> <g data-name="Layer 30" id="Layer_30"> <path class="cls-1" d="M12.52,13.59,63,13.39l-7.1,28H20.23l-8.86-32H1.25"></path> <circle class="cls-1" cx="23.83" cy="52.17" r="3.92"></circle> <circle class="cls-1" cx="53.1" cy="52.17" r="3.92"></circle> <line class="cls-1" x1="17.65" x2="58.29" y1="32.1" y2="32.1"></line> <line class="cls-1" x1="15" x2="60.7" y1="22.56" y2="22.56"></line> <line class="cls-1" x1="24.15" x2="24.15" y1="13.54" y2="41.41"></line> <line class="cls-1" x1="15.83" x2="15.83" y1="13.54" y2="25.54"></line> <line class="cls-1" x1="32.41" x2="32.41" y1="13.54" y2="41.41"></line> <line class="cls-1" x1="40.66" x2="40.66" y1="13.54" y2="41.41"></line> <line class="cls-1" x1="48.92" x2="48.92" y1="13.54" y2="41.41"></line> <line class="cls-1" x1="57.18" x2="57.18" y1="13.54" y2="36.47"></line> <path class="cls-1" d="M20.23,41.41V45.7a2.55,2.55,0,0,0,2.55,2.55H53.24"></path> </g> </g></svg>
                                <svg id="vitamina-car-${contadorVitaminas}" class="hover:scale-125" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill-rule="evenodd" clip-rule="evenodd" d="M12 6.00019C10.2006 3.90317 7.19377 3.2551 4.93923 5.17534C2.68468 7.09558 2.36727 10.3061 4.13778 12.5772C5.60984 14.4654 10.0648 18.4479 11.5249 19.7369C11.6882 19.8811 11.7699 19.9532 11.8652 19.9815C11.9483 20.0062 12.0393 20.0062 12.1225 19.9815C12.2178 19.9532 12.2994 19.8811 12.4628 19.7369C13.9229 18.4479 18.3778 14.4654 19.8499 12.5772C21.6204 10.3061 21.3417 7.07538 19.0484 5.17534C16.7551 3.2753 13.7994 3.90317 12 6.00019Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>`;
            botones.classList.add("w-[80px]", "h-[60px]", "flex", "flex-row", "gap-[15px]","cursor-pointer")
            caja.appendChild(imagen);
            caja.appendChild(lista);
            caja.appendChild(botones);
            ...
            document.getElementById(`vitamina-car-${contadorVitaminas}`).addEventListener("click", ()=>{
                let carritoActual = localStorage.getItem("carrito") ? JSON.parse(localStorage.getItem("carrito")) : [];
        ...
        ropayaccesorios.map((ropaacs)=>{
            ...
            botones.innerHTML = `<svg id="ropa-car-${contadorAccesorios}" class="hover:scale-125" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <defs> <style>.cls-1{fill:none;stroke:#000000;stroke-linecap:round;stroke-linejoin:round;stroke-width:2px;}</style> </defs> <title></title> <g data-name="Layer 30" id="Layer_30"> <path class="cls-1" d="M12.52,13.59,63,13.39l-7.1,28H20.23l-8.86-32H1.25"></path> <circle class="cls-1" cx="23.83" cy="52.17" r="3.92"></circle> <circle class="cls-1" cx="53.1" cy="52.17" r="3.92"></circle> <line class="cls-1" x1="17.65" x2="58.29" y1="32.1" y2="32.1"></line> <line class="cls-1" x1="15" x2="60.7" y1="22.56" y2="22.56"></line> <line class="cls-1" x1="24.15" x2="24.15" y1="13.54" y2="41.41"></line> <line class="cls-1" x1="15.83" x2="15.83" y1="13.54" y2="25.54"></line> <line class="cls-1" x1="32.41" x2="32.41" y1="13.54" y2="41.41"></line> <line class="cls-1" x1="40.66" x2="40.66" y1="13.54" y2="41.41"></line> <line class="cls-1" x1="48.92" x2="48.92" y1="13.54" y2="41.41"></line> <line class="cls-1" x1="57.18" x2="57.18" y1="13.54" y2="36.47"></line> <path class="cls-1" d="M20.23,41.41V45.7a2.55,2.55,0,0,0,2.55,2.55H53.24"></path> </g> </g></svg>
                                <svg id="ropa-car-${contadorAccesorios}" class="hover:scale-125" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill-rule="evenodd" clip-rule="evenodd" d="M12 6.00019C10.2006 3.90317 7.19377 3.2551 4.93923 5.17534C2.68468 7.09558 2.36727 10.3061 4.13778 12.5772C5.60984 14.4654 10.0648 18.4479 11.5249 19.7369C11.6882 19.8811 11.7699 19.9532 11.8652 19.9815C11.9483 20.0062 12.0393 20.0062 12.1225 19.9815C12.2178 19.9532 12.2994 19.8811 12.4628 19.7369C13.9229 18.4479 18.3778 14.4654 19.8499 12.5772C21.6204 10.3061 21.3417 7.07538 19.0484 5.17534C16.7551 3.2753 13.7994 3.90317 12 6.00019Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>`;
            botones.classList.add("w-[80px]", "h-[60px]", "flex", "flex-row", "gap-[15px]","cursor-pointer")
            caja.appendChild(imagen);
            caja.appendChild(lista);
            caja.appendChild(botones);
            ...
            document.getElementById(`ropa-car-${contadorAccesorios}`).addEventListener("click", ()=>{
                let carritoActual = localStorage.getItem("carrito") ? JSON.parse(localStorage.getItem("carrito")) : [];
        ...
        cepillos.map((cepi)=>{
            ...
            botones.innerHTML = `<svg id="cepi-car-${contadorCepillos}" class="hover:scale-125" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" fill="#000000"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <defs> <style>.cls-1{fill:none;stroke:#000000;stroke-linecap:round;stroke-linejoin:round;stroke-width:2px;}</style> </defs> <title></title> <g data-name="Layer 30" id="Layer_30"> <path class="cls-1" d="M12.52,13.59,63,13.39l-7.1,28H20.23l-8.86-32H1.25"></path> <circle class="cls-1" cx="23.83" cy="52.17" r="3.92"></circle> <circle class="cls-1" cx="53.1" cy="52.17" r="3.92"></circle> <line class="cls-1" x1="17.65" x2="58.29" y1="32.1" y2="32.1"></line> <line class="cls-1" x1="15" x2="60.7" y1="22.56" y2="22.56"></line> <line class="cls-1" x1="24.15" x2="24.15" y1="13.54" y2="41.41"></line> <line class="cls-1" x1="15.83" x2="15.83" y1="13.54" y2="25.54"></line> <line class="cls-1" x1="32.41" x2="32.41" y1="13.54" y2="41.41"></line> <line class="cls-1" x1="40.66" x2="40.66" y1="13.54" y2="41.41"></line> <line class="cls-1" x1="48.92" x2="48.92" y1="13.54" y2="41.41"></line> <line class="cls-1" x1="57.18" x2="57.18" y1="13.54" y2="36.47"></line> <path class="cls-1" d="M20.23,41.41V45.7a2.55,2.55,0,0,0,2.55,2.55H53.24"></path> </g> </g></svg>
                                <svg id="cepi-car-${contadorCepillos}" class="hover:scale-125" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fill-rule="evenodd" clip-rule="evenodd" d="M12 6.00019C10.2006 3.90317 7.19377 3.2551 4.93923 5.17534C2.68468 7.09558 2.36727 10.3061 4.13778 12.5772C5.60984 14.4654 10.0648 18.4479 11.5249 19.7369C11.6882 19.8811 11.7699 19.9532 11.8652 19.9815C11.9483 20.0062 12.0393 20.0062 12.1225 19.9815C12.2178 19.9532 12.2994 19.8811 12.4628 19.7369C13.9229 18.4479 18.3778 14.4654 19.8499 12.5772C21.6204 10.3061 21.3417 7.07538 19.0484 5.17534C16.7551 3.2753 13.7994 3.90317 12 6.00019Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>`;
            botones.classList.add("w-[80px]", "h-[60px]", "flex", "flex-row", "gap-[15px]","cursor-pointer")
            caja.appendChild(imagen);
            caja.appendChild(lista);
            caja.appendChild(botones);
            ...
            document.getElementById(`cepi-car-${contadorCepillos}`).addEventListener("click", ()=>{
                let carritoActual = localStorage.getItem("carrito") ? JSON.parse(localStorage.getItem("carrito")) : [];
